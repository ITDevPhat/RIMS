...
export function mapApiProjectToUi(project: ApiResearchProject): ResearchProject {
  return {
    ...
    principalInvestigatorEmail: project.principalInvestigatorEmail ?? null,
    ...
    registrationDatePrecision: normalizeDatePrecision(project.registrationDatePrecision),
    proposalReviewDate: project.proposalReviewDate ?? null,
    proposalReviewDatePrecision: normalizeDatePrecision(project.proposalReviewDatePrecision),
    acceptanceDate: project.acceptanceDate ?? null,
    acceptanceDatePrecision: normalizeDatePrecision(project.acceptanceDatePrecision),
