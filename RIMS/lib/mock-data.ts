...
export const mockDeadlines: DeadlineItem[] = [
  { id: "d1", researchId: "4", researchCode: "NC-2026-004", researchName: "Đặc điểm lâm sàng và cận lâm sàng của người bệnh viêm phổi cộng đồng nhập viện", type: "Hoàn tất thu thập xét nghiệm và hình ảnh học", dueDate: "2026-06-30", dueDatePrecision: "DAY", daysRemaining: -3, assignee: "BS Trần Hải Đăng", status: "Quá hạn", priority: "critical" },
  { id: "d2", researchId: "1", researchCode: "NC-2026-001", researchName: "Nghiên cứu tỷ lệ kiểm soát huyết áp ở người bệnh tăng huyết áp điều trị ngoại trú", type: "Kiểm tra thiếu dữ liệu định kỳ", dueDate: "2026-08-31", dueDatePrecision: "DAY", daysRemaining: 59, assignee: "CN Võ Thị Thanh", status: "Chưa bắt đầu", priority: "normal" },
  { id: "d3", researchId: "2", researchCode: "NC-2026-002", researchName: "Đánh giá hiệu quả tư vấn dinh dưỡng cho người bệnh đái tháo đường type 2", type: "Hoàn tất tư vấn dinh dưỡng", dueDate: "2026-08-15", dueDatePrecision: "DAY", daysRemaining: 43, assignee: "CN Phạm Ngọc Hân", status: "Đang thực hiện", priority: "normal" },
  { id: "d4", researchId: "3", researchCode: "NC-2026-003", researchName: "Khảo sát thời gian chờ khám tại khoa Khám bệnh", type: "Phân tích điểm nghẽn", dueDate: "2026-07-15", dueDatePrecision: "DAY", daysRemaining: 12, assignee: "CN Võ Thị Thanh", status: "Đang thực hiện", priority: "medium" },
  { id: "d5", researchId: "5", researchCode: "NC-2026-005", researchName: "Đánh giá mức độ hài lòng của người bệnh nội trú", type: "Xin ý kiến hội đồng đạo đức", dueDate: "2026-06-30", dueDatePrecision: "DAY", daysRemaining: -3, assignee: "Phòng Công tác xã hội", status: "Quá hạn", priority: "high" },
  { id: "d6", researchId: "5", researchCode: "NC-2026-005", researchName: "Đánh giá mức độ hài lòng của người bệnh nội trú", type: "Tập huấn khảo sát viên", dueDate: "2026-07-20", dueDatePrecision: "DAY", daysRemaining: 17, assignee: "CN Lê Thị Thu Hà", status: "Chưa bắt đầu", priority: "medium" },
  { id: "d7", researchId: "1", researchCode: "NC-2026-001", researchName: "Nghiên cứu tỷ lệ kiểm soát huyết áp ở người bệnh tăng huyết áp điều trị ngoại trú", type: "Báo cáo tiến độ thu thập số liệu", dueDate: "2026-07-31", dueDatePrecision: "DAY", daysRemaining: 28, assignee: "CN Phạm Ngọc Hân", status: "Đang thực hiện", priority: "high" },
];
